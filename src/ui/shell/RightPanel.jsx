      ...
      <div className="flex-1 overflow-y-auto">
        {!item ? (
          <div className="flex flex-col items-center justify-center h-full px-4 text-center gap-2">
            <div className="w-8 h-8 rounded border border-pf-steel/30 flex items-center justify-center">
          ...
          <div className="p-3 space-y-4">
            ...
            <div className="flex items-center gap-2.5">
              ...
              />
              <div>
                <p className="text-pf-sand text-sm font-semibold">{def?.label}</p>
                <p className="text-pf-steel text-xs">{item.type}</p>
              </div>
            </div>

            {/* Dimensions */}
            <div>
              <p className="text-pf-steel text-xs uppercase tracking-wider mb-1.5">Dimensions</p>
              <div className="grid grid-cols-3 gap-1">
                {[
                  ...
                  <div key={label} className="bg-pf-navy/50 rounded p-1.5 text-center">
                    <p className="text-pf-steel text-[10px]">{label}</p>
            ...
            {/* Position */}
            <div>
              <p className="text-pf-steel text-xs uppercase tracking-wider mb-1.5">Position</p>
              <div className="grid grid-cols-3 gap-1">
                {['X', 'Z', 'Yaw'].map((label, i) => {
            ...
            {/* Weekly cost */}
            <div className="flex justify-between items-center py-2 border-t border-pf-steel/20">
              <span className="text-pf-steel text-xs">Weekly hire</span>
              <span className="text-pf-sand text-sm font-bold">${def?.weekly}/wk</span>
            </div>

            {/* Actions */}
            <div>
              <p className="text-pf-steel text-xs uppercase tracking-wider mb-1.5">Actions</p>
