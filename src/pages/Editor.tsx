 ...
 * Editor Page
 *
 * Main 3D editor interface for site planning with resizable panels.
 * Shows a 3D viewport with building catalog, properties inspector, and site summary.
 */
export const Editor: React.FC<EditorProps> = () => {
  ...
  }, [projectId, getProjectById, setCurrentProjectId, navigate]);
